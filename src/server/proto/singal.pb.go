...
func (x *ProduceRequest) GetMethod() string {
	if x != nil {
		return x.Method
	}
	return ""
...
type ConsumeRequest struct {
	...
	RtpParameters *RtpParameters         `protobuf:"bytes,8,opt,name=rtpParameters,proto3" json:"rtpParameters,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ConsumeRequest) GetMethod() string {
	if x != nil {
		return x.Method
	}
	return ""
...
func (x *WorkerRegister) GetPublicIp() string {
	if x != nil {
		return x.PublicIp
	}
	return ""
...
func (x *WorkerRegister) GetPublicPort() uint32 {
	if x != nil {
		return x.PublicPort
	}
	return 0
...
func (x *WorkerRegister) GetUseUdp() bool {
	if x != nil {
		return x.UseUdp
	}
	return false
...
func (x *WorkerKeepalive) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WorkerKeepalive) ProtoMessage() {}

func (x *WorkerKeepalive) ProtoReflect() protoreflect.Message {
	mi := &file_singal_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WorkerKeepalive.ProtoReflect.Descriptor instead.
func (*WorkerKeepalive) Descriptor() ([]byte, []int) {
	return file_singal_proto_rawDescGZIP(), []int{23}
}

func (x *WorkerKeepalive) GetWorkerId() string {
	if x != nil {
		return x.WorkerId
	}
	return ""
...
type WorkerToServer struct {
	...
	//	*WorkerToServer_WorkerRegister
	//	*WorkerToServer_WorkerKeepalive
...
func (x *WorkerToServer) GetWorkerRegister() *WorkerRegister {
	if x != nil {
		if x, ok := x.Payload.(*WorkerToServer_WorkerRegister); ok {
...
func (x *WorkerToServer) GetWorkerKeepalive() *WorkerKeepalive {
	if x != nil {
		if x, ok := x.Payload.(*WorkerToServer_WorkerKeepalive); ok {
			return x.WorkerKeepalive
		}
	}
	return nil
}
...
type WorkerToServer_WorkerRegister struct {
	WorkerRegister *WorkerRegister `protobuf:"bytes,7,opt,name=worker_register,json=workerRegister,proto3,oneof"`
}

type WorkerToServer_WorkerKeepalive struct {
	WorkerKeepalive *WorkerKeepalive `protobuf:"bytes,8,opt,name=worker_keepalive,json=workerKeepalive,proto3,oneof"`
}

type WorkerToServer_StatsPush struct {
	StatsPush string `protobuf:"bytes,9,opt,name=stats_push,json=statsPush,proto3,oneof"`
}
...
func (*WorkerToServer_WorkerRegister) isWorkerToServer_Payload() {}

func (*WorkerToServer_WorkerKeepalive) isWorkerToServer_Payload() {}
...
const file_singal_proto_rawDesc = "" +
	...
	"\bapp_data\x18\x05 \x01(\tR\aappData\x12\x16\n" +
	"\x06method\x18\x06 \x01(\tR\x06method\x12;\n" +
	"\rrtpParameters\x18\a \x01(\v2\x15.server.RtpParametersR\rrtpParameters\"o\n" +
	"\x0fProduceResponse\x12\x1f\n" +
	"\vproducer_id\x18\x01 \x01(\tR\n" +
	"producerId\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess\x12!\n" +
	"\ferror_detail\x18\x03 \x01(\tR\verrorDetail\"\x96\x02\n" +
	...
	"\bapp_data\x18\x06 \x01(\tR\aappData\x12\x16\n" +
	"\x06method\x18\a \x01(\tR\x06method\x12;\n" +
	"\rrtpParameters\x18\b \x01(\v2\x15.server.RtpParametersR\rrtpParameters\"\xb7\x01\n" +
	...
	"produceRes\x12<\n" +
	"\fconsumer_res\x18\x06 \x01(\v2\x17.server.ConsumeResponseH\x00R\vconsumerRes\x12A\n" +
	"\x0fworker_register\x18\a \x01(\v2\x16.server.WorkerRegisterH\x00R\x0eworkerRegister\x12D\n" +
...
func file_singal_proto_init() {
	...
	file_singal_proto_msgTypes[26].OneofWrappers = []any{
		...
		(*WorkerToServer_WorkerRegister)(nil),
